...
package storm.bolt.nonDisPipeline;
...
public class NonDisPipelineBolt extends BaseRichBolt {
    ...
    public NonDisPipelineBolt(String boltName, String[] nonPipelineBoltsName, String[] inFieldsName, String[] outFieldsName, String calibrationFileAddr, String rectificationFileAddr, int imgRows,
	...
	InetAddress inetAddress = InetAddress. getLocalHost();
	    ...
	    */
        ...
        byte[] xyz = ReconstructionAPI.reprojectTo3D(leftImgByte, Q, imgRows, imgCols);
